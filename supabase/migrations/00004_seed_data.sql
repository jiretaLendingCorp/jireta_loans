...
INSERT INTO report_templates (template_key, title, description, parameters_schema) VALUES
  ...
  ('lender_report',        'Lender/Borrower Report',       'All registered lenders with account upgrade and loan status',               '{"status":{"type":"string","optional":true},"account_upgrade_status":{"type":"string","optional":true}}'),
