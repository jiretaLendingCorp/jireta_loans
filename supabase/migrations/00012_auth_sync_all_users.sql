...
-- Migration : 00012_auth_sync_all_users.sql
-- Purpose   : Placeholder to keep local migration history aligned with the
--             remote history table (a 00012 version already exists on the
--             linked project). The actual fix content is applied by
--             00013_auth_sync_all_users.sql which is idempotent.
-- =====================================================================
