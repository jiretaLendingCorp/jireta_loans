...
const COLLECTION_SELECT = `id, loan_schedule_id, status, collection_type, rider_id, assigned_by, requested_by, requested_at, assigned_at, amount_collected, requested_amount, collection_schedule, response_at, completed_at, created_at,
