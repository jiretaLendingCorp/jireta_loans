...
async function handleCreateLender(req: Request) {
  ...
  // NOTE (00128): only identity is stored on the lender profile. Employment /
  // income / source of funds / emergency contact are declared per LOAN and
  // snapshot onto loans / loan_emergency_contacts at application time.
