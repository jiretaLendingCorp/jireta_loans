...
class FakeKpiDS extends KpiRemoteDataSource {
  ...
  @override
  Future<KpiHeadManagerModel> getHeadManagerKpi({String? month, String? date}) async => buildKpi();
}
...
class FakeDashboardNotifier extends HmDashboardNotifier {
  ...
  @override
  Future<void> loadKpis({String? month, String? date, bool silent = false}) async {
