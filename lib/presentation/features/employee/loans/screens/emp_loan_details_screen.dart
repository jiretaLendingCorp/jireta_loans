...
class EmpLoanDetailsScreen extends ConsumerStatefulWidget {
  final String loanId;
  const EmpLoanDetailsScreen({super.key, required this.loanId});

  @override
  ConsumerState<EmpLoanDetailsScreen> createState() =>
      _EmpLoanDetailsScreenState();
}

class _EmpLoanDetailsScreenState extends ConsumerState<EmpLoanDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    return WebScaffold(
      ...
      actions: [
        TextButton.icon(
          onPressed: () => context.go(RouteConstants.empActiveLoans),
