...
final empPaymentListProvider = AutoDisposeStateNotifierProvider<
    EmpPaymentNotifier, AsyncValue<Map<String, dynamic>>>((ref) {
  return EmpPaymentNotifier(sl<PaymentRemoteDataSource>());
});

class EmpPaymentNotifier extends StateNotifier<AsyncValue<Map<String, dynamic>>>
  ...
  Future<void> loadList(
      {String? method, String? status, int page = 1, bool silent = false}) async {
