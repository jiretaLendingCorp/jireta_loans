...
class _HmArchivedScreenState extends ConsumerState<HmArchivedScreen> {
  ...
  void _onDateRangeChanged(DateTimeRange? r) {
    ...
    ref.read(hmArchivedProvider.notifier).setDateRange(
  ...
  Widget _table(HmArchivedState state) => SingleChildScrollView(
        padding: const EdgeInsets.all(16),
        child: Column(
          ...
          children: [
            ...
            RecordsPagination(
              ...
              onPageChange: (p) =>
                  ref.read(hmArchivedProvider.notifier).setPage(p),
            ),
          ],
        ),
      );
