...
class _HmReportLibraryScreenState extends ConsumerState<HmReportLibraryScreen> {
  ...
  List<Map<String, dynamic>> _defaultTemplates() => [
        ...
        {'key': 'borrower_report', 'name': 'Lender Report', 'description': 'All registered lenders and their status', 'icon': Icons.people_rounded, 'has_pdf': true, 'has_excel': true, 'accent': AppColors.lenderBlue, 'category': 'Users'},
