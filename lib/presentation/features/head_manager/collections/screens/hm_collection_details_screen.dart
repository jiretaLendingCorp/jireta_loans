...
class HmCollectionDetailsScreen extends ConsumerWidget {
            ...
            final leftColumn = Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              _PremiumSectionCard(
                ...
                child: Column(children: [
                  ...
                  _InfoRow('Completed At', col.completedAt != null ? dateFmt.format(col.completedAt!) : 'N/A'),
                  const Divider(height: 20),
  ...
  Widget _buildStatusCard(CollectionAssignmentModel col) {
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      // ito ng backend sa `record` step (status=in_progress, may payment na
      // pero wala pang proof). Completed lang kapag status==completed.
