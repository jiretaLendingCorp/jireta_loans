  ...
  Widget _infoCard(UserModel user) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            _row('Vehicle Type', user.vehicleType ?? '—'),
            _row('Vehicle Brand', user.vehicleBrand ?? '—'),
            _row('Plate Number', user.plateNumber ?? '—'),
            _row('Driver\'s License', user.driversLicenseNumber ?? '—'),
