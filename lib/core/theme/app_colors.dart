...
class AppColors {
  ...
  static const Color lenderPurple = Color(0xFF6A1B9A);
  static const Color lenderPurpleLight = Color(0xFF9C27B0);
  static const Color lenderPurpleDark = Color(0xFF4A148C);
