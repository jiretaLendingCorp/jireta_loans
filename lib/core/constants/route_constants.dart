...
class RouteConstants {
  ...
  /// Lender: kinukumpirma ang email na inilagay sa "Fill In Information" sa
  /// pamamagitan ng LINK na ipinadala sa email (hindi OTP code).
  ...
  static const String hmHeadManagers = '/hm/head-managers';
